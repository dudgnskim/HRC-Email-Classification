...
### external function(2): removes punctuations, numbers and multiple whitespaces.
remove_extra = function(x) {
  # Removing multiple whitespaces, numbers and punctuations.
  gsub("\\s+", " ", gsub("*\\b[[:alpha:]]{1,2}\\b *", " ",
                         gsub("[[:digit:]]", "", gsub("[[:punct:]]", "", x))))
}
exclude_redundancy = function(x) {
  ...
  redun <- c("unclassified u.s. department of state case no.", "doc no.", "date:",
             ...
             "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "a.m.",
             "p.m.", "i'm", "re:", "a.m", "p.m", "am", "pm", "f-", "release in full",
             "release in part", "state-", "january", "february", "march", "april", "may",
