...
hrc <- read.table(file.choose(), stringsAsFactors = FALSE)
dtm<-clean_documents(Corpus(VectorSource(hrc$V2)), stopwords)
```
...
power_features_ngrams = function(hrc, stopwordss = stopwords, ngram = 2, min_sparsity = 0.99) {
  hrc = tm_map(hrc, content_transformer(tolower))
